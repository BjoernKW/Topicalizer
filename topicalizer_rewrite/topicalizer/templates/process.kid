...
<body>
<form method="post" action="${tg.url('/process')}">
  <table align="center">
    <tr>
      <td>
...
<table py:if="error == 0" align="center">
  <tr>
	...
	<tr>
	  ...
	  <td class="maintext">
	    <table>
	      <tr py:for="sentence, occurrences in abstract">
      ...
      <br /><span py:if="url != 'text'"><a href="${tg.url('/getSimilarDocuments/?url=' + url)}">Find similar documents</a></span><span py:if="url == 'text'"><a href="${tg.url('/getSimilarDocuments/?plainText=' + query)}">Find similar documents</a></span>
    </td>
    <td>
      <br />

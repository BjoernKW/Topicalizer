...
<body>
<form method="post" action="${tg.url('/processAugmentedKeywords')}">
  <table align="center">
    <tr>
      <td>
  ...
  <input type="hidden" name="submit" value="augment keywords!" />
  <input type="submit" value="augment keywords!" />
...
<table py:if="error == 0" align="center">
  <tr>
    <td width="750">
      <h1>Augmented keywords for '${XML(corpus)}'</h1><br />
      ${languageTitle}<br /><br /><hr /><br />
      <table width="100%">
	<tr>
	  <td class="maintext">
	    <span py:for="keyword in keywords">${keyword}<br /></span>
	  </td>
	</tr>
      </table>
    </td>

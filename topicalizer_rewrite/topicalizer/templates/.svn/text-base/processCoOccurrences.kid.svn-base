...
<body>
<form method="post" action="${tg.url('/processCoOccurrences')}">
  <table align="center">
    <tr>
      <td>
...
<table py:if="error == 0" align="center">
  <tr>
    <td width="750">
      <h1>Co-occurrences for '${XML(corpus)}'</h1><br />
      ${languageTitle}, text category: ${textCategoryTitleDisplay}<br /><br /><hr /><br />
      <table width="100%">
	<tr>
	  <td class="maintext">

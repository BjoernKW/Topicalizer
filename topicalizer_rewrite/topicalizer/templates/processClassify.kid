...
<body>
<form method="post" action="${tg.url('/processClassify')}">
  <table align="center">
    <tr>
      <td>
	<textarea class="greentext" name="plainText1" cols="30" rows="5">Enter first reference text</textarea>
      </td>
      <td>
	<textarea class="greentext" name="plainText2" cols="30" rows="5">Enter second reference text</textarea>
      </td>
      <td>
	<textarea class="greentext" name="plainText3" cols="30" rows="5">Enter text to compare reference texts with</textarea>
      </td>
    </tr>
    <tr>
      <td>
...
<br /><br /><br />
<table py:if="success == 1" align="center">
  <tr>
    <td width="600">
      <h1>Text comparison</h1><br />
      <h2>Language</h2><br />
      ${languageTitle}, character set: ${charset}<br /><br /><hr /><br />
      <h2>Classification</h2><br />
      The compared text is of the same category as the ${category} at a probability of ${categoryProbability}.<br />
    </td>
  </tr>
</table>
<table py:if="success == 0" align="center">
  <tr>
    <td width="600">
      <h1>Text comparison</h1><br />
      <h2>Language</h2><br />
      ${languageTitle}<br /><br /><hr /><br />
      <h2>Classification</h2><br />
      Sorry, the submitted texts are not long enough for making a conclusive guess.<br />
    </td>
  </tr>
</table>
</body>

...
listOfSourceFiles = os.listdir('../core/languageprofiles/sourcefiles/')
...
for sourceFileName in listOfSourceFiles:
    ...
    if dotAtBeginning.findall(sourceFileName):
    	...
    	sourceFile = codecs.open('../core/languageprofiles/sourcefiles/' + sourceFileName, 'r', 'iso-8859-1')
    	profileFile = codecs.open('../core/languageprofiles/' + sourceFileName, 'w', 'iso-8859-1')

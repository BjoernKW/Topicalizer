...
<table align="center">
  <tr>
    <td width="600">
      The following tools are currently available:<br /><br />
      - <a href="/augmentKeywords/">Augmented keyword extraction</a><br />
      - <a href="/coOccurrences/">Get co-occurrences for keywords</a><br />
      - <a href="/similarDocuments/">Search for similar documents</a><br />
      - <a href="/semWeb/">Semantic Web Creator</a><br />
      - <a href="/api/"> Topicalizer API</a><br />
      - <a href="/classify/">Text classifier</a><br />
    </td>
  </tr>
</table>
</body>

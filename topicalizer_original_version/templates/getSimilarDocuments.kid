  ...
  <tr>
	...
	<tr>
	  <td class="maintext">
		...
		<td>
		  <a href="${document.URL}" target="_blank"><span py:content="XML(document.title)">X</span></a> &rArr; <a href="/getSimilarDocuments/?url=${document.URL}">Find similar documents</a> &rArr; <a href="/process/?url=${document.URL}&amp;language=automatic">Topicalize</a><br />
		</td>
	      </tr>
	    </table>
	  </td>
